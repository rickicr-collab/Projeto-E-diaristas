...
import br.com.rickicollab.ediaristas.api.dtos.requests.CidadesAtendidasRequest;
import br.com.rickicollab.ediaristas.api.dtos.response.MensagemResponse;
import br.com.rickicollab.ediaristas.api.mappers.ApiCidadeAtendidaMapper;
import br.com.rickicollab.ediaristas.core.exceptions.CidadeAtendidaNaoEncontradaException;
import br.com.rickicollab.ediaristas.core.models.CidadeAtendida;
import br.com.rickicollab.ediaristas.core.repositories.CidadeAtendidaRepository;
import br.com.rickicollab.ediaristas.core.repositories.UsuarioRepository;
import br.com.rickicollab.ediaristas.core.services.consultacidade.adapters.ConsultaCidadeService;
...
public class ApiCidadesAtendidasService {
    ...
    public List<br.com.rickicollab.ediaristas.api.dtos.response.CidadeAtendidaResponse> listarCidadesAtendidas() {
    ...
    public br.com.rickicollab.ediaristas.api.dtos.response.MensagemResponse atualizarCidadesAtendidas(CidadesAtendidasRequest request) {

...
import br.com.rickicollab.ediaristas.api.dtos.requests.ResetSenhaConfirmacaoRequest;
import br.com.rickicollab.ediaristas.api.dtos.requests.ResetSenhaRequest;
...
import br.com.rickicollab.ediaristas.core.services.PasswordResetService;
...
public class ApiResetSenhaService {
    ...
    @Value("${br.com.rickicollab.ediaristas.frontend.host}")

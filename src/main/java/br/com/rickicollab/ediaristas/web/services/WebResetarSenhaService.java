...
import br.com.rickicollab.ediaristas.web.dto.ResetarSenhaConfirmacaoForm;
import br.com.rickicollab.ediaristas.web.dto.ResetarSenhaForm;
...
public class WebResetarSenhaService {
    ...
    @Value("${br.com.rickicollab.ediaristas.backend.host}")

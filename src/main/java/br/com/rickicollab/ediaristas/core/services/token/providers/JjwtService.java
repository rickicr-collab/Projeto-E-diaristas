package br.com.rickicollab.ediaristas.core.services.token.providers;
...
public class JjwtService implements TokenService {
    ...
    @Value("${br.com.rickicollab.ediaristas.access.key}")
    private String accessKey;

    @Value("${br.com.rickicollab.ediaristas.access.expiration}")
    private int accessExpiration;

    @Value("${br.com.rickicollab.ediaristas.refresh.key}")
    private String refreshKey;

    @Value("${br.com.rickicollab.ediaristas.refresh.expiration}")

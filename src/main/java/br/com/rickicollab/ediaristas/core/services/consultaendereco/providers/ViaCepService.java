package br.com.rickicollab.ediaristas.core.services.consultaendereco.providers;
...
import br.com.rickicollab.ediaristas.core.services.consultaendereco.adapters.EnderecoService;
...
public class ViaCepService implements EnderecoService {
    ...
    public EnderecoResponse buscarEnderecoPorCep(String cep) throws EnderecoServiceException {
        ...
        try {
            ...
            throw new EnderecoServiceException("O CEP informado está inválido");
        }

        var body = response.getBody();

        if (body == null || body.hasError()) {
            throw new EnderecoServiceException("O CEP informado não existe");
        }
        return body;
    }
